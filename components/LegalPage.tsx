...
export function LegalPage({
  ...
  return (
    <main id="main-content" tabIndex={-1} className="bg-gradient-to-b from-mist/70 via-white to-white py-20 md:py-28">
